'use strict';
/* build-hook-start *//*00001*/try { require('/Users/camth/.vscode/extensions/wallabyjs.console-ninja-1.0.462/out/buildHook/index.js').default({tool: 'jest', checkSum: '2088fef98522ec94f61583CgFIUkgJAgBRUwFRAVdXDgADCwIP', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/camth/.vscode/extensions/wallabyjs.console-ninja-1.0.462/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '2088fef98522ec94f61583CgFIUkgJAgBRUwFRAVdXDgADCwIP', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
